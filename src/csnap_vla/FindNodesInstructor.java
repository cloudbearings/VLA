...
public class FindNodesInstructor extends DefaultHandler {
	public String[][] getNodes(String words){  
		...
		try {  
		     ...
		     if (synonymTag.equals("open")) {  
		      ...
		      for (int j = 0; j < wordsString.length; j=j+1){
		    	  if (wordsString[j].equalsIgnoreCase(synonymString)){
		    		  nodeFlag = true;
		    		  //System.out.println(synonymString);
		    		  nodeMatrix[levelNumber-1][nodeNumber-1] = "l" + levelNumber + "n" + nodeNumber;
		    	  }  
		      }
		   ...
		   // accordingly  
		   saxParser.parse("/Users/salvatoregiorgi/Desktop/NodeConfigFile.xml", defaultHandler); 
