...
public class Lab_part2_questions extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Lab_part2_questions frame = new Lab_part2_questions();
	...
	public Lab_part2_questions()  {
		...
		this.setTitle("lab_part2_questions");
		...
		//go to the next questions screen
		...
		//go back to the description (hardcoded for ece2313)
		JButton btnNewButton_1 = new JButton("Back");
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Lab_Part_Description back = new Lab_Part_Description(null, "ECE2313", "Ohm's Law", "1");
		...
		Object[][] data = {{"0 V", "0", "0", "0"}, {"2 V", "","",""}, {"4 V", "","",""}, {"6 V", "","",""}, {"8 V", "","",""}, {"10 V", "","",""}}; 
		...
		JLabel lblNewLabel_2 = new JLabel("Are the percent differences sufficiently small to establish that the current determined by Ohm's Law will be very close to that measured directly?");
		lblNewLabel_2.setBounds(204, 187, 824, 14);
		contentPane.add(lblNewLabel_2);
		
		textField = new JTextField();
		textField.setBounds(224, 212, 86, 20);
		...
		lblNewLabel_3.setBounds(204, 243, 870, 14);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("voltage or current. Using this graph, fill in the missing cells in the table below.");
		lblNewLabel_4.setBounds(204, 260, 714, 14);
		contentPane.add(lblNewLabel_4);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(214, 285, 274, 71);
		contentPane.add(scrollPane_1);
		
		String[] columns = {"Ir (mA)", "Vr (V)", "R (Ohms)"};
		Object[][] table_2_data = {{"5.6","",""},{"1.2","",""},{"","8.3",""}}; 
		...
		//saves the graph results and answers to a word document file.
		...
		btnNewButton_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					...
					wordMLPackage.getMainDocumentPart().addStyledParagraphOfText("Title", "Lab 1");
					wordMLPackage.getMainDocumentPart().addStyledParagraphOfText("Subtitle",
					"Ohm's Law");
					
					wordMLPackage.getMainDocumentPart().addStyledParagraphOfText("Heading1","Part 1");
					wordMLPackage.getMainDocumentPart().addStyledParagraphOfText("Heading3","Using a 1000 Ohm Resistor:");
					Tbl table = createFirstTable(factory, wordMLPackage);
					
					addBorders(table);
					wordMLPackage.getMainDocumentPart().addObject(table);
					
					wordMLPackage.getMainDocumentPart().addStyledParagraphOfText("Heading3","Are the percent differences sufficiently"
							+ " small to establish that the current determined by Ohm's Law will be very close to "
							+ "that measured directly?");
					wordMLPackage.getMainDocumentPart().addParagraphOfText(textField.getText());
    ...
    private static Tbl createSecondTable(org.docx4j.wml.ObjectFactory factory, WordprocessingMLPackage wordMLPackage) {
        ...
        addTableCell(tableRow1, "Ir (mA)", factory, wordMLPackage);
        addTableCell(tableRow1, "Vr (V)", factory, wordMLPackage);
        addTableCell(tableRow1, "R (Ohms)", factory, wordMLPackage);
        
        addTableCell(tableRow2, "5.6", factory, wordMLPackage);
        ...
        addTableCell(tableRow3, "1.2", factory, wordMLPackage);
        ...
        addTableCell(tableRow4, table_2.getValueAt(2,0).toString(), factory, wordMLPackage);
        addTableCell(tableRow4, "8.3", factory, wordMLPackage);
        addTableCell(tableRow4, table_2.getValueAt(2,2).toString(), factory, wordMLPackage);
